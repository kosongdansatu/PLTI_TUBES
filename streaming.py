...
def run(
        weights='/Users/danusuma/opt/anaconda3/envs/PLTI-TUBES/runs/train/exp4/weights/last.pt',  # model path or triton URL
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='/Users/danusuma/opt/anaconda3/envs/PLTI-TUBES/runs/train/exp4/weights/last.pt', help='model path or triton URL')
